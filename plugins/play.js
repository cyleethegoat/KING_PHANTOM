...
smd({
  ...
  try {
    ...
    await _0x213b75.bot.sendMessage(_0x213b75.jid, {
      'image': _0x4342ba,
      'caption': "\n*ᴋɪɴɢ_ᴘʜᴀɴᴛᴏᴍ • ᴍᴜꜱɪᴄ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*\n\n*Title :* " + _0x4f86cb.title + "\n*Url :* " + _0x4f86cb.url + "\n*Description :* " + _0x4f86cb.timestamp + "\n*Views :* " + _0x4f86cb.views + "\n*Uploaded :* " + _0x4f86cb.ago + "\n*Author :* " + _0x4f86cb.author.name + "\n\n_𝙿𝙷𝙰𝙽𝚃𝙾𝙼 𝙸𝚂 𝚃𝚁𝚈𝙸𝙽𝙶 𝚃𝙾 𝚂𝙸𝙽𝙶 𝚃𝙷𝙴 𝚂𝙾𝙽𝙶..._\n"
    });

    // Use the new API to get download links
    const downloadApiUrl = "https://ironman.koyeb.app/ironman/dl/ytdl2?url=" + encodeURIComponent(_0x4f86cb.url);
...
smd({
  ...
  try {
    ...
    // Use the new API to get download links
    const downloadApiUrl = "https://api-gifted-tech.onrender.com/api/download/ytdl?url=$" + encodeURIComponent(youtubeUrl);
...
smd({
  ...
  try {
    ...
    // Use the new API to get download links
    const downloadApiUrl = "https://api-gifted-tech.onrender.com/api/download/ytmp3v2?url=" + encodeURIComponent(youtubeUrl);
...
smd({
  ...
  try {
    ...
    await _0x213b75.bot.sendMessage(_0x213b75.jid, {
      'image': _0x4342ba,
      'caption': "\n* • ᴋɪɴɢ_ᴘʜᴀɴᴛᴏᴍ ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*\n\n*Title :* " + _0x4f86cb.title + "\n*Url :* " + _0x4f86cb.url + "\n*Description :* " + _0x4f86cb.timestamp + "\n*Views :* " + _0x4f86cb.views + "\n*Uploaded :* " + _0x4f86cb.ago + "\n*Author :* " + _0x4f86cb.author.name + "\n\n_𝙿𝙷𝙰𝙽𝚃𝙾𝙼 𝙸𝚂 𝙿𝚁𝙴𝙿𝙰𝚁𝙸𝙽𝙶 𝚃𝙷𝙴 𝚅𝙸𝙳𝙴𝙾..._\n"
    });
