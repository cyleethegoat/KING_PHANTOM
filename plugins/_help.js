...
➮𝙏𝞘𝞛𝞢 - ${message.time} 
➮𝘾𝞢𝞗- *𝕻𝖍𝖆𝖓𝖙𝖔𝖒*
➮𝘾𝞗-𝙁𝞗𝙐𝞜𝘿𝞢𝞒𝙎- 𝞘𝞑𝞒𝞓𝞖𝞘𝞛 𝞓𝘿𝞓𝞛𝙎, 𝞑𝞓𝞒𝞓𝞙𝞓 𝞑𝞢𝙂𝞓 𝞓𝞜𝘿 𝞙𝞘𝞜𝙂 𝞖𝞓𝞙𝞘
➮𝞗𝙒𝞜𝞢𝞒 - ${Config.ownername} 
➮𝞜𝙐𝞛𝞑𝞢𝞒 - ${owner.split(",")[0]} 
➮𝞛𝞢𝞛𝞗𝞒𝙔 - ${formatp(os.totalmem() - os.freemem())} 
      \n *𝞙𝞘𝞜𝙂_𝞠𝞖𝞓𝞜𝙏𝞗𝞛 𝞓 𝙎𝞘𝞛𝞠𝙇𝞢 𝙒𝞖𝞓𝙏𝙎𝞓𝞠𝞠 𝞑𝞗𝙏*\n\n ${readmore} 
╭──❰ 𝞓𝙇𝙇 𝞛𝞢𝞜𝙐 ❱ 
│
│⚔️ 𝙇𝞘𝙎𝙏  
│⚔️ 𝘾𝞓𝙏𝞢𝙂𝞗𝞒𝙔
...
smd(
  ...
  async (message) => {
    ...
    const { key } = await message.reply("👑𝚃𝙷𝙴 𝙺𝙸𝙽𝙶'𝚂 𝙰𝚄𝚁𝙰 𝙸𝚂");

    // Wait briefly for effect
    await new Promise((r) => setTimeout(r, 1500));

    var speed = new Date().getTime() - startTime;
    await message.send(`*𝙿𝙾𝙽𝙶!
    ${speed} ms ⚡`, { edit: key });
  }
);
astro_patch.cmd(
...
astro_patch.cmd(
  ...
  async (message) => {
    try {
      ...
      let listMessage = `\n  
━━👉 * ${Config.botname} * 👈    
┃ ☾✨︎☽︎ 𝞠𝞒𝞢𝙁𝞘𝞦: ${Config.HANDLERS}
┃ ☾✨☽︎ 𝞗𝙒𝞜𝞢𝞒: ${Config.ownername}
┃ ☾︎✨☽︎ 𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝙎: ${commands.length}
┃ ☾✨☽︎ 𝞒𝙐𝞜𝙏𝞘𝞛𝞢: ${runtime(process.uptime())}
┃ ☾✨︎☽︎ 𝞛𝞢𝞛𝞗𝞒𝙔: ${formatp(os.totalmem() - os.freemem())}
╰━━━━━━━━━━━━━━⊷\n`;
