...
smd(
    ...
    try {
      ...
      if (!repoUrl) {
        return await _0x1ae8f8.reply(
          "*Provide Repo URL, e.g., .git https://github.com/STAR-KING0/KINGKING_PHANTOM_*"
        );
      }
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is PHANTOM>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am KING_PHANTOM-Md whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "KING_PHANTOM-Md-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     } catch (_0x3537cb) {
 ...
 smd({
   pattern: "sound",
    alias: ["PHANTOMi", "aine","mentalism","alive","waso"],
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "PHANTOM tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd({
   ...
   try {
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "PHANTOM-Md--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
