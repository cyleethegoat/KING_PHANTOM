let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `ᴘʜᴀɴᴛᴏᴍ ᴄʜᴀɴɴᴇʟ\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.comchannel/0029VarUpFs2ZjCmM38C463O\n\n ${Config.botname} *©𝙋𝙃𝘼𝙉𝙏𝙊𝙈 *`;
