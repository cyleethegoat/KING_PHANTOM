...
async function syncdb() {
  ...
  client.ev.on("connection.update", async connectionUpdate => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec = 
`✨Now Arise *${Config.botname}*! The 𝕻𝖍𝖆𝖓𝖙𝖔𝖒 has entered the field ✨
「 *Arise Systems* Now Active 」

⚜️ *Prefix* : ${Config.HANDLERS}
📜 *Commands* : ${events.commands.length} Decrees Issued
⚒️ *Mode* : ${Config.WORKTYPE} Governance
🏰 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "𝕻𝖍𝖆𝖓𝖙𝖔𝖒 Core")}
⚔️ *Captain*     : ${Config.ownername}
🛡 *Royal Guard*: ${global.sudo}
...
<div class="bounce-text">Cosmo-Hunter</div>
